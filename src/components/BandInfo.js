...
const BandInfo = () => {
  ...
  const { ticketMasterResults, searchTerm } = useContext(AuthContext);
      ...
      {searchTerm && (
        <VStack spacing={4}>
          ...
          {currentTicker.map((event) => (
            <Box key={event.id} data-aos="fade-up" border="1px" bg="#020024" boxShadow="#121212" height="50%" width="100%" borderRadius="md" p={4}>
